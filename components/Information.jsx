...
function Information(){
    return (
        <>
        <div className="w-full h-auto flex flex-col  md:flex-row pt-4 justify-center text-slate-600" style={{backgroundColor : '#EEF7FF'}}>
        ...
        <div className="flex flex-1 p-5 font-bold items-center">
